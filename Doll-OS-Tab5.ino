...
static void prioritizeDsiScanout() {
    ...
    //DW-GDMA AXI master ports. Give both read ports the highest AXI QoS value because
    //an interrupted scanout produces the characteristic full-screen blue/cyan flash.
    axi_icm_ll_set_dw_gdma_qos_arbiter_prio(0, 0, 15);
    axi_icm_ll_set_dw_gdma_qos_arbiter_prio(1, 0, 15);
    Serial.println("[display] DSI DW-GDMA read QoS: 15/15");
#endif
}  // Protects continuous DSI reads from bursts generated by CPU, cache, USB, and SDIO.
