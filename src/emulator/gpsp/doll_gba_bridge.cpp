...
extern u32 gba_thumb_predecode_queue_drops;
extern u32 gba_thumb_predecode_set_drops;
extern u32 gba_thumb_predecode_duplicates;
...
void doll_gba_core_get_perf(doll_gba_perf_stats_t* stats) {
  ...
  stats->thumb_predecode_queue_drops = gba_thumb_predecode_queue_drops;
  stats->thumb_predecode_set_drops = gba_thumb_predecode_set_drops;
  stats->thumb_predecode_duplicates = gba_thumb_predecode_duplicates;
