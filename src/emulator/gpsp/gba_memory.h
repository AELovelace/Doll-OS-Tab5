...
extern u8 vram[GBA_VRAM_SIZE];
extern u8 bios_rom[GBA_BIOS_ROM_SIZE];
// Double buffer used for SMC detection
extern u8 ewram[GBA_EWRAM_SIZE];
extern u8 iwram[GBA_IWRAM_SIZE];
...
extern u8 gamepak_backup[GBA_GAMEPAK_BACKUP_SIZE];
...
#define vram gbsp_memory->p_vram
#define bios_rom gbsp_memory->p_bios_rom
#define ewram gbsp_memory->p_ewram
